"""Ashby fetcher orchestration entry point."""
...
async def fetch_ashby_jobs(
    ...
    *,
    ...
    Returns:
        ...
        sources_failed)``.
    """
    fetcher_cls = resolve_fetcher_attr("AshbyFetcher", AshbyFetcher)
    ...
    for company_name, config in companies.items():
        ...
        try:
            ...
            async with fetcher_cls(company_name, board_id) as fetcher:
